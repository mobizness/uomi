...
- (void) configureView
{
    ...
    _lowerHandleHiddenWidth = 0.0f;
    _upperHandleHiddenWidth = 0.0f;
...
//    CGFloat rightOffset = leftOffset;
    ...
    return UIEdgeInsetsMake(topOffset, 0, bottomOffset, 0);
}

- (UIEdgeInsets) trackAlignmentInsetsForBackTrack
{
    UIEdgeInsets lowerAlignmentInsets = self.lowerHandleImageNormal.alignmentRectInsets;
    UIEdgeInsets upperAlignmentInsets = self.upperHandleImageNormal.alignmentRectInsets;
    ...
    return UIEdgeInsetsMake(topOffset, leftOffset + 5, bottomOffset, rightOffset + 5);
}
 ...
 -(CGRect) trackBackgroundRect
{
    ...
    UIEdgeInsets alignmentInsets = [self trackAlignmentInsetsForBackTrack];
